  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
    	...
    	%>
    		...
    		<a class="btn btn-dark" href="/ASM3/login?action=login" role="button">Login</a>
    		<a class="btn btn-dark" href="/ASM3/login?action=register" role="button">Register</a>

    	<%
    		} else {
    	%>
    		<a class="nav-link disabled" href="">${user}</a>
    		<a class="btn btn-dark" href="/ASM3/logout?action=logout" role="button">Logout</a>
